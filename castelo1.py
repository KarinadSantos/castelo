...
def desenhar_castelo():
    ...
    zoom = 2
    turtle.setup(800, 600)  # Definindo um tamanho maior para a tela

    # Centraliza o ponto de origem no centro da tela
    turtle.penup()
    turtle.goto(-150, -100)  # Ajusta a tartaruga para o centro do desenho
    turtle.pendown()

    # Retângulo (corpo do castelo)
    turtle.begin_fill()
    turtle.color("purple")
